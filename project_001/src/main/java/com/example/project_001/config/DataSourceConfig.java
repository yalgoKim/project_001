...
@Configuration
@MapperScan(value="com.example.project_001.mapper", sqlSessionFactoryRef = "SqlSessionFactory")
public class DataSourceConfig {
    ...
    public SqlSessionFactory SqlSessionFactory(@Qualifier("dataSource") DataSource DataSource, ApplicationContext applicationContext) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.example.project_001.dto");
